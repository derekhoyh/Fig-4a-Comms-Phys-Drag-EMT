...
text(-57,28,'(a)','FontSize',25);
text(-58,16,'Inhomogeneous','FontSize',19);
text(-58,14,'momentum drag','FontSize',19);
text(-53,11,'$(\eta <0)$','Interpreter', 'latex','FontSize',19);

text(28,16,'$n_{A} = -n_{P}$', 'Interpreter', 'latex','FontSize',22);
...
text(2,0.55,'$T=10K$','Interpreter', 'latex','FontSize',12);
